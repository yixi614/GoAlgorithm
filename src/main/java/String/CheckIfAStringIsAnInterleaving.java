 ...
 * if it contains all characters of A and B and order of all characters in
 * individual strings is preserved. See Permutation/InterleavingsOfTwoStrings for example
 *
 *
 *
 *
 * */
public class CheckIfAStringIsAnInterleaving {
//  Solution:
...
//  If the character matches with first character of A, then repeat the above process from second character of C,second character of A and first character of B.
